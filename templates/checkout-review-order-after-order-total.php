<?php
/**
 * The Template for displaying cart weight on checkout page.
 *
 * This template can be overridden by copying it to yourtheme/woo-cart-weight/checkout-review-order-after-order-total.php.
 *
