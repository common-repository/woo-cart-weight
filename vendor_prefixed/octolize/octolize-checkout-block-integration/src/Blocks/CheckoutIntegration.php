...
class CheckoutIntegration implements IntegrationInterface
{
    ...
    private function register_main_integration(): void
    {
        ...
        wp_set_script_translations($this->integration_name . '-blocks-integration', 'woo-cart-weight', $this->plugin_dir . '/lang');
    }
    ...
    public function register_block_editor_scripts(): void
    {
        ...
        wp_set_script_translations($this->integration_name . '-blocks-integration-editor', 'woo-cart-weight', $this->plugin_dir . '/lang');
    }
    public function register_block_frontend_scripts(): void
    {
        ...
        wp_set_script_translations($this->integration_name . '-blocks-integration-frontend', 'woo-cart-weight', $this->plugin_dir . '/lang');
    }
