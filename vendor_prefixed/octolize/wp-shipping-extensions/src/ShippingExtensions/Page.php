...
use WCWeightVendor\Octolize\ShippingExtensions\Plugin\PluginSorter;
...
class Page implements Hookable
{
    ...
    {
        add_submenu_page(self::PARENT_SLUG, _x('Shipping Extensions', 'Page title', 'woo-cart-weight'), $this->get_menu_title(), 'manage_options', self::MENU_SLUG, [$this, 'render_page']);
    }
    /**
     * @return void
     */
    ...
    {
        $menu_title = nl2br(_x("Shipping\nExtensions", 'Menu Title', 'woo-cart-weight'));
