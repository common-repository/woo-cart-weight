...
?>" style="display:none;">
	<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'woo-cart-weight'), $plugin_title);
?></h2>
...
?>">
		<div class="body">
			<div class="panel active" data-panel-id="reasons">
				<p><?php 
\_e('Before you proceed, please take 30 seconds to let us know what brought you to this decision. Your answers are anonymous.', 'woo-cart-weight');
?></p>
...
\_e('Skip &amp; Deactivate', 'woo-cart-weight');
?></a>
                </div>
