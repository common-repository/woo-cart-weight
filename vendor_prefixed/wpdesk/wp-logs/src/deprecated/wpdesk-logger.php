...
if (!\class_exists('WCWeightVendor\WPDesk_Logger')) {
    ...
    class WPDesk_Logger
    {
        ...
        {
            return ['disabled' => \__('Disabled', 'woo-cart-weight'), 'emergency' => \__('Emergency', 'woo-cart-weight'), 'alert' => \__('Alert', 'woo-cart-weight'), 'critical' => \__('Critical', 'woo-cart-weight'), 'error' => \__('Error', 'woo-cart-weight'), 'warning' => \__('Warning', 'woo-cart-weight'), 'notice' => \__('Notice', 'woo-cart-weight'), 'info' => \__('Info', 'woo-cart-weight'), 'debug' => \__('Debug', 'woo-cart-weight')];
        }
        /**
         * @param string $level
         * @param string $source
