...
class WPCapture
{
    ...
    private function add_notice_for_dir($dir)
    {
        new \WCWeightVendor\WPDesk\Notice\Notice(sprintf(
            ...
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'woo-cart-weight'),
            $dir
        ), \WCWeightVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \WCWeightVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'woo-cart-weight'),
            $file
        ), \WCWeightVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
