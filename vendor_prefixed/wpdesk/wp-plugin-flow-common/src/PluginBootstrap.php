...
namespace WCWeightVendor\WPDesk\Plugin\Flow;
...
final class PluginBootstrap
{
     ...
     */
    private function init_translations(\WCWeightVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \WCWeightVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \WCWeightVendor\WPDesk_Plugin_Info();
