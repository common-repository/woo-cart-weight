...
namespace WCWeightVendor\WPDesk\Notice;

use WCWeightVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use WCWeightVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
