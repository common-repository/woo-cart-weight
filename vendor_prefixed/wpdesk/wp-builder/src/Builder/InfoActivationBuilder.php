...
namespace WCWeightVendor\WPDesk\PluginBuilder\Builder;

use WCWeightVendor\WPDesk\PluginBuilder\Plugin\AbstractPlugin;
use WCWeightVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use WCWeightVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\WCWeightVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
