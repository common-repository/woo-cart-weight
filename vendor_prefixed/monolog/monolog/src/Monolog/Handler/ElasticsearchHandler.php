...
use WCWeightVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use WCWeightVendor\Monolog\Logger;
use WCWeightVendor\Monolog\Formatter\FormatterInterface;
use WCWeightVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use WCWeightVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use WCWeightVendor\Elasticsearch\Client;
use WCWeightVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use WCWeightVendor\Elastic\Elasticsearch\Client as Client8;
/**
