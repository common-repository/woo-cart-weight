...
use WCWeightVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use WCWeightVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use WCWeightVendor\Monolog\Logger;
use WCWeightVendor\Monolog\ResettableInterface;
