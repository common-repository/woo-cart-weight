...
use WCWeightVendor\PhpConsole\Connector;
use WCWeightVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use WCWeightVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('WCWeightVendor\PhpConsole\Connector')) {
