...
use WCWeightVendor\Swift_Message;
use WCWeightVendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\WCWeightVendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
