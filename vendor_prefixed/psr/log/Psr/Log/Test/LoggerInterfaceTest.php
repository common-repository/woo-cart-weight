...
namespace WCWeightVendor\Psr\Log\Test;

use WCWeightVendor\Psr\Log\LoggerInterface;
use WCWeightVendor\Psr\Log\LogLevel;
use WCWeightVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('WCWeightVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WCWeightVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WCWeightVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
